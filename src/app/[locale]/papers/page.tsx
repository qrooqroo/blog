...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: { absolute: isKo ? '논문 분석 | AI Insight Note' : 'Papers | AI Insight Note' },
    description: isKo
      ? 'AI, 머신러닝, 반도체, 로보틱스 등 최신 논문을 심층 분석한 아카이브.'
      : 'In-depth analysis of the latest papers in AI, ML, semiconductors, and robotics.',
    alternates: { canonical: `https://aiinsightnote.com/${locale}/papers` },
  };
}
